...
const whatToDoForLunch = function(hungry, availableTime) {
  ...
  if (hungry == false) {console.log("Wait until you're hungry"); return;}
  if (availableTime < 20) {console.log("Pick something up and eat in back in the Lab or in the kitchen, where you can get to know your fellow classmatesinue"); return;}
  if (availableTime < 30) {console.log("You deserve a break. Try a place in Gastown"); return;}
  console.log("You should reconsider your plans");
